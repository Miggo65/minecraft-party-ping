...
public class PingClientMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        pingKey = KeyBindingHelper.registerKeyBinding(createKeyBinding(
            "key.mcping.ping",
            InputUtil.Type.MOUSE,
            GLFW.GLFW_MOUSE_BUTTON_MIDDLE
        ));

        partyMenuKey = KeyBindingHelper.registerKeyBinding(createKeyBinding(
            "key.mcping.party",
        ...
        // World-space ping rendering is now handled by WorldRendererPingMixin
        // (WorldRenderEvents was removed from Fabric API in 1.21.9)
    ...
    private static final KeyBinding.Category PING_CATEGORY =
            KeyBinding.Category.create(Identifier.of("simplemultiplayerping", "general"));

    private static KeyBinding createKeyBinding(String translationKey, InputUtil.Type inputType, int code) {
        return new KeyBinding(translationKey, inputType, code, PING_CATEGORY);
    }
