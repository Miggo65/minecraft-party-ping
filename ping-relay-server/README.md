...
Nutzungs-Tracker anzeigen (per SSH):
...
- höchste gleichzeitige Nutzerzahl (Peak)
- Anzahl unterschiedlicher Nutzer insgesamt
...
Optional kannst du den Speicherort der Stats-Datei setzen:

```bash
STATS_FILE=/var/lib/ping-relay/usage-stats.json npm start
```
